...
import vinayImg from '../assets/team/vinay.png'
import saniyaImg from '../assets/team/saniya.png'
import anmolImg from '../assets/team/anmol.png'
...
const team = [
  {
    ...
    image: vinayImg,
    skills: ['Security Systems', 'Digital Solutions', 'Strategy'],
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, i) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 p-6 pt-10 transition-all duration-500 hover:border-orange-500/50 hover:bg-white/10 group">
